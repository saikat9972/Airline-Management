...
public class New_Booking extends JFrame{ //Third Frame
	...
	JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;
        ...
        public New_Booking(){
            ...
            JLabel Classno = new JLabel("CLASSCODE");
            Classno.setFont(new Font("Tahoma", Font.PLAIN, 17));
            Classno.setBounds(60, 80, 150, 27);
            add(Classno);
            ...
            Ticketprice.setFont(new Font("Tahoma", Font.PLAIN, 17));
            Ticketprice.setBounds(60, 120, 150, 27);
            add(Ticketprice);
            ...
            Paymentid.setFont(new Font("Tahoma", Font.PLAIN, 17));
            Paymentid.setBounds(60, 170, 150, 27);
            add(Paymentid);
            ...
            JLabel AddPassengers = new JLabel("NEW BOOKING");
            ...
            Next.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    String class_code = textField.getText();
                    String price_paid = textField_1.getText();
                    String payment_id =  textField_2.getText();
                    ...
                    try {
                        conn c = new conn();
                        String str = "INSERT INTO passenger values( '"+name+"', '"+gender+"', '"+address+"','"+ph_no+"', '"+payment_id+"', '"+fl_code+"','"+class_code+"', '"+price_paid+"')";
