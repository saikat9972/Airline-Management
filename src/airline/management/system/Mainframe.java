...
public class Mainframe extends JFrame{
	...
	NewLabel.setBounds(0, 0, 1900, 788); 
	add(NewLabel); 
	...
	JMenuItem ReservationDetails = new JMenuItem("NEW BOOKING");
	AirlineSystem.add(ReservationDetails);
		
	JMenuItem PassengerDetails = new JMenuItem("FLIGHTS");
	AirlineSystem.add(PassengerDetails);
		
	JMenuItem SectorDetails_1 = new JMenuItem("BOOKING DETAILS");
